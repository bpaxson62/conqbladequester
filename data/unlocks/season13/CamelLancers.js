module.exports = {
  ...
  tier: 1,
  season: 13,
  prerequisites: [{ unlockId: 'jangjus', requiredStages: 3 }],
  requiredPerStage: 8,
  unitChallenges: [
    {
      key: 0,
    ...
    {
      key: 8,
      text: 'Get a Troop Kill Score of 300 or higher with 10 units in Field or Siege Battles of any type.',
      stage: 1
    },
    {
      key: 9,
    ...
    { key: 1, text: 'Achieve victory in 8 Raider Camps or Bandit Raids.', stage: 2 },
    {
      key: 2,
      text: 'Get an A rating or better in 8 Free Battles, or get an A+ rating or better in 8 Field or Siege Battles of any type.',
      stage: 2
    },
    { key: 3, text: 'Search 12 loot sites in the open world.', stage: 2 },
    ...
    { key: 0, text: 'Get an A+ rating or better in 8 Expedition battles.', stage: 3 },
    ...
    {
      key: 7,
      text: 'Get a Troop Kill Score of 400 or higher with any unit in 8 Field or Siege Battles of any type.',
      stage: 3
    },
    {
      key: 8,
    ...
    { key: 0, text: 'Search 12 loot sites in the open world.', stage: 4 },
    { key: 1, text: 'Achieve victory in 8 Raider Camps or Bandit Raids.', stage: 4 },
    {
      key: 2,
      text: 'Get a Troop Kill Score of 600 or more in 8 Ranked battles, or get a Troop Kill Score of 1000 or more in 8 Field or Siege Battles of any type.',
      stage: 4
    },
    ...
    {
      key: 9,
      text: 'Use Camel Lancers and kill 100 soldiers in Field or Siege battles.',
      stage: 4
    },
    { key: 0, text: 'Use Camel Lancers and win 12 Expeditions or Bandit Raids.', stage: 5 },
    {
      key: 1,
      text: 'In Field or Siege Battles of any type, use Camel Lancers to kill 30 enemy soldiers.',
      stage: 5
    },
    {
      key: 2,
    ...
    {
      key: 8,
      text: 'Get a Troop Kill Score of 600 or more in 8 Ranked battles, or get a Troop Kill Score of 1000 or more in Field or Siege Battles of any type.',
      stage: 5
    },
    { key: 9, text: 'Get an A+ rating or better in 8 Expedition battles.', stage: 5 }
  ]
}
