module.exports = {
  ...
  tier: 1,
  season: 15,
  prerequisites: [{ unlockId: 'ronin', requiredStages: 2 }],
  requiredPerStage: 8,
  unitChallenges: [
    {
      key: 0,
    ...
    { key: 2, text: 'Get an A+ rating or better in 8 Expedition battles.', stage: 1 },
    { key: 3, text: 'Achieve victory in 8 Raider Camps or Bandit Raids.', stage: 1 },
    { key: 4, text: 'Complete 12 Fief Quests.', stage: 1 },
    { key: 5, text: 'Defeat a band of rebels 12 times in the open world.', stage: 1 },
    {
      key: 6,
    ...
    { key: 4, text: 'Complete 12 Fief Quests.', stage: 2 },
    {
      key: 5,
    ...
    { key: 3, text: 'Complete 12 Daily Quests.', stage: 3 },
    {
      key: 4,
    ...
    { key: 1, text: 'Defeat 1200 troops during Expeditions.', stage: 4 },
    {
      key: 2,
    ...
    {
      key: 9,
      text: 'In Field or Siege Battles of any type, use the Onna-musha "Onslaught" skill to kill 200 enemy soldiers.',
      stage: 4
    },
    {
      key: 0,
      text: 'Use Onna-musha and win 8 PvE Battles (excluding Training Battle and Deploy & Defend).',
      stage: 5
    },
    {
      key: 1,
      text: 'In Field or Siege Battles of any type, use the Onna-musha "Charge" skill to kill 100 enemy soldiers.',
      stage: 5
    },
    {
      key: 2,
